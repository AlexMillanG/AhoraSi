                            ...
                            <div class="container-fluid"
                                ...
                                <table class="table" style=" margin-top: 25px; margin-bottom: 2%;">
                                    <tr style="height: 130px;">
                                        ...
                                        <th rowspan="2">
                                            <img src="../../assets/img/logo1.png" class="card-img-top" alt="..."; style="border-radius: 50%;">
                                        </th>
                                    </tr>
                                </table>
                                <h6 style="font-family: PT serif ; font-size: 15px; color: #5A6AA9">Nombre Completo:</h6>
                                <h6 style="font-family: PT serif ; font-size: 15px; ">${admin.name} ${admin.lastname} ${admin.surname}</h6>
                                <h6 style="font-family: PT serif ; font-size: 15px; color: #5A6AA9">Correo: <h6 style="font-family: PT serif ; font-size: 15px; text-align: left; color: #1a1d20">${admin.email}</h6></h6>
                                <h6 style="font-family: PT serif ; font-size: 15px; color: #5A6AA9">Fecha de Nacimiento: <h6 style="font-family: PT serif ; font-size: 15px; text-align: left; color: #1a1d20">${admin.birthday}</h6></h6>
                                <h6 style="font-family: PT serif ; font-size: 15px; color: #5A6AA9">Sexo: <h6 style="font-family: PT serif ; font-size: 15px; text-align: left; color: #1a1d20">${admin.sex}</h6></h6>
                            </div>
                        </s:forEach>
                    </div>
                </div>
...
<div class="modal fade" id="saveAdmins" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" >
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 30px;">
            ...
            <p  style="font-family: PT serif; font-size: 35px; text-align: center; margin-top: 20px; font-style: normal;font-weight: 700;"><strong>Agregar Administrador</strong></p>
